...
raw_train_ds = keras.utils.text_dataset_from_directory(
    "/workspaces/AI-DEMO/文本处理/aclImdb/train",
...
raw_test_ds = keras.utils.text_dataset_from_directory(
    "/workspaces/AI-DEMO/文本处理/aclImdb/test", batch_size=batch_size
)
...
# save model
model.save('/workspaces/AI-DEMO/文本处理/text_classification_from_scratch.keras')
